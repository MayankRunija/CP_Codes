class Solution {
    ...
    public List<String> alertNames(String[] keyName, String[] keyTime) {
        ...
        final PriorityQueue<String> resultQueue = new PriorityQueue();
        ...
        final List<String> result = new ArrayList(resultQueue.size());
    ...
    private int timeToSeconds(String s) {
        int result = 
            (((int) (s.charAt(0))) - SHIFT) * 10 + (((int) (s.charAt(1))) - SHIFT);
